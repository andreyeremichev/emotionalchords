...
const EMOTION_COPY: Record<EmotionId, EmotionCopy> = {
  playful: {
    ...
    outroLine2: "to keep motion effortless",
  },
  ...
  mystery: {
    ...
    outroLine1: "Mix them 🌀",
    outroLine2: "to lose and regain direction",
  },
  ...
  sadness: {
    ...
    outroLine1: "Use both 💙",
    outroLine2: "to hear withdrawal clearly",
  },
  ...
  fear: {
    ...
    outroLine2: "to feel instability",
  },
  ...
  tension: {
    ...
    outroLine1: "Use both 🪢",
    outroLine2: "to sustain pressure",
  },
